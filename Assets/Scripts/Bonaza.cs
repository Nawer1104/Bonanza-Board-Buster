...
public class Bonaza : MonoBehaviour
{
    public static Bonaza Instance;
    ...
    {
        if (!moveAble) return;
        if (collision.gameObject.GetComponent<SpriteRenderer>().sprite == gameObject.GetComponent<SpriteRenderer>().sprite)
        {
